...
public abstract class JsonProcessingHelper {
   ...
   * @throws Exception When a nested object is included in the JsonValue an Exception is thrown.
   *                   Because it is not supported to have nested documents at the moment.
   */
  public static Object getJavaTypeFromJsonJsonValue(JsonValue jsonValue)
   ...
   * @throws Exception Whenever the JsonArray includes a nested JsonObject value. Because it is not
